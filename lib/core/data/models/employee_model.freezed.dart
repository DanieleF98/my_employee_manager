    ...
    return _then(_value.copyWith(
      ...
      email: freezed == email
          ...
          : email // ignore: cast_nullable_to_non_nullable
              as String?,
      workShifts: freezed == workShifts
          ? _value.workShifts
          : workShifts // ignore: cast_nullable_to_non_nullable
              as List<WorkShiftModel?>?,
      employmentDate: freezed == employmentDate
          ? _value.employmentDate
          : employmentDate // ignore: cast_nullable_to_non_nullable
              as int?,
      totalActiveNotifications: freezed == totalActiveNotifications
...
class _$_EmployeeModel implements _EmployeeModel {
  ...
  @override
  final String? email;
  final List<WorkShiftModel?>? _workShifts;
  @override
  List<WorkShiftModel?>? get workShifts {
    final value = _workShifts;
    if (value == null) return null;
    if (_workShifts is EqualUnmodifiableListView) return _workShifts;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._workShifts, _workShifts) &&
